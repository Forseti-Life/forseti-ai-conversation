...
> **Checkpoint note (2026-05-17):** This repository received a checkpoint check-in on `main`; see recent history for the exact Bedrock/runtime updates included in that snapshot.
