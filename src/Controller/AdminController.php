...
class AdminController extends ControllerBase {
  ...
  public function updateSystemPrompt() {
    // Get the default Forseti Assistance system prompt from PromptManager.
    ...
    return new JsonResponse([
      'success' => $success,
      'message' => $success ? 'Forseti Assistance system prompt updated successfully' : 'Failed to update system prompt',
